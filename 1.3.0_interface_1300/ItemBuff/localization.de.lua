...
if ( GetLocale() == "deDE" ) then
	...
	ITEMBUFF_FROZEN			= "Fenster: auf Position festgesetzt";
	...
	ITEMBUFF_HELP_TEXT5		= "|cffffffff"..ITEMBUFF_FREEZE.."|r|cff00ff00: setzt das Fenster auf der momentanen Position fest, sodass es nicht mehr verschoben werden kann.|r";
	ITEMBUFF_HELP_TEXT6		= "|cffffffff"..ITEMBUFF_UNFREEZE.."|r|cff00ff00: setzt das Fenster wieder frei, sodass es wieder verschoben werden kann.|r";
	ITEMBUFF_HELP_TEXT7		= "|cffffffff"..ITEMBUFF_RESET.."|r|cff00ff00: setzt das Fenster auf seine Standardposition zur\195\188ck.|r";
	ITEMBUFF_HELP_TEXT8		= " ";
	ITEMBUFF_HELP_TEXT9		= "|cff00ff00Beispiel: |r|cffffffff/itembuff freeze|r|cff00ff00 setzt das Fenster auf der momentanen Position fest und verhindert somit, da\195\159 jenes verschoben werden kann.|r";
