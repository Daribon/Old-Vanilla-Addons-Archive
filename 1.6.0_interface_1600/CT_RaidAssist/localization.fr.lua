if ( GetLocale() == "frFR" ) then
    ...
    CT_RAMENU_MISCDESCRIPT = "'Rapporter pour les Autres' vous permet de rapporter la vie et la mana d\'un autre joueur de votre groupe qui n\'a pas CT_RaidAssist d\'install\195\169. Leur vie et mana seront rapport\195\169s comme si ils utilisaient le mod, cependant les buffs et debuffs ne seront pas fonctionnels. Il est recommand\195\169 que tout le monde dans le raid poss\195\168de le mod. Mana Conserve vous permet de auto-annuler le lancement de soins si la cible a plus de X% de vie quand le sort est sur le point d\'aboutir |c00FFFFFFet que vous \195\170tes en combat|r. Notez que vous devez garder la m\195\170me cible tout au long du lancement pour que \195\167\195\160 marche.";
	...
	CT_RA_MARKOFTHEWILD = { "Marque de la nature", "Cadeau de la nature" };
	CT_RA_ARCANEINTELLECT = { "Intelligence des arcanes", "Illumination des arcanes" };
	CT_RA_ADMIRALSHAT = "Chapeau d\'amiral";
	CT_RA_SHADOWPROTECTION = "Protection contre l\'ombre";
	CT_RA_POWERWORDSHIELD = "Mot de pouvoir : Bouclier";
	CT_RA_SOULSTONERESURRECTION = "R\195\169surrection de Pierre d\'\195\162me";
	CT_RA_DIVINESPIRIT = "Esprit divin";
	CT_RA_THORNS = "Epines";
	CT_RA_FEARWARD = "Gardien de peur";
	CT_RA_BLESSINGOFMIGHT = "B\195\169n\195\169diction de puissance";
	CT_RA_BLESSINGOFWISDOM = "B\195\169n\195\169diction de sagesse";
	CT_RA_BLESSINGOFKINGS = "B\195\169n\195\169diction des rois";  
	CT_RA_BLESSINGOFSALVATION = "B\195\169n\195\169diction de salut";
	CT_RA_BLESSINGOFLIGHT = "B\195\169n\195\169diction de lumi\195\168re";
	CT_RA_BLESSINGOFSANCTUARY = "B\195\169n\195\169diction du Sanctuaire";
	...
	CT_RA_RECENTLYBANDAGED = "Un_bandage_a_\195\169t\195\169_appliqu\195\169_r\195\169cemment";
	
	-- Cures
	CT_RA_DISPELMAGIC = "Dissiper Magie";
