...
--	
--	$Id: localization.lua 2158 2005-07-22 09:18:54Z mugendai $
--	$Rev: 2158 $
--	$LastChangedBy: mugendai $
--	$Date: 2005-07-22 04:18:54 -0500 (Fri, 22 Jul 2005) $
--]]
...
CASTOPTIONS_CONFIG_TEXTURE_INFO	= "If enabled will print the texture of the spell that was just cast.";
...
CASTOPTIONS_CHAT_TEXTURE = "Texture Printing %s";
