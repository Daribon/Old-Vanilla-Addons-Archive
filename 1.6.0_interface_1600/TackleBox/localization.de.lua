...
--		"German Localization"
--	
--	By: DrVanGogh, StarDust
--	
--	$Id: localization.de.lua 2121 2005-07-12 14:20:21Z Sinaloit $
--	$Rev: 2121 $
--	$LastChangedBy: Sinaloit $
--	$Date: 2005-07-12 09:20:21 -0500 (Tue, 12 Jul 2005) $
--]]
...
if ( GetLocale() == "deDE" ) then
	...
	TACKLEBOX_OUTPUT_SWITCH			= "Makro Erstellung";
