...
--[[ Standard Prints ]]--
	...
	dprint = function ( debugKey, ... )
		Sea.IO.dprintf(debugKey, Sea.IO.DEFAULT_CHAT_FRAME, unpack(arg));
	end;
	...
	dprintc = function ( debugKey, color, ... )
		Sea.IO.dprintfc(debugKey, Sea.IO.DEFAULT_CHAT_FRAME, color,  unpack(arg));
	end;
