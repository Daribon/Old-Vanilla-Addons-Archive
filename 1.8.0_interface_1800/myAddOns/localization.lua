...
MYADDONS_NOT_LOAD_ONDEMAND = "This AddOn is not loaded on demand.";
...
if (clientLanguage == "deDE") then
	MYADDONS_RELEASE_DATE = "15. Oktober 2005";
...
elseif (clientLanguage == "frFR") then
	MYADDONS_RELEASE_DATE = "15 Octobre 2005";
