...
--	By: StarDust
--	
--	$Id: localization.de.lua 2656 2005-10-19 16:05:33Z stardust $
--	$Rev: 2656 $
--	$LastChangedBy StarDust $
--	$Date: 2005-10-19 11:05:33 -0500 (Wed, 19 Oct 2005) $
--]]
...
if (GetLocale()=="deDE") then
	...
	CASTOPTIONS_CONFIG_SMARTEQUIP		= "Intelligentes Zaubern auf Ausr\195\188stung";
	CASTOPTIONS_CONFIG_SMARTEQUIP_INFO	= "Wenn aktiviert, wird beim Wirken eines Ausr\195\188stungsbuffs der passende momentan angelegte Gegenstand automatisch daf\195\188r ausgew\195\164hlt.";
	...
	CASTOPTIONS_CONFIG_RANK_HEADER		= "Intelligentes Zaubern nach Rang";
	CASTOPTIONS_CONFIG_RANK_HEADER_INFO	= "Optionen zum Zaubern nach unterschiedlichen R\195\164ngen.";
	...
	CASTOPTIONS_CONFIG_SMARTHEAL		= "Intelligentes Heilen nach Rang";
	CASTOPTIONS_CONFIG_SMARTHEAL_INFO	= "Wenn aktiviert, wird beim Heilen das Ziel dahingehend \195\188berpr\195\188ft und automatisch der niedrigste Heilzauber ausgewählt um das Ziel auf die gew\195\188nschte Gesundheit zu heilen.";
	CASTOPTIONS_CONFIG_HEALBOOST		= "Extra Gesundheit";
	CASTOPTIONS_CONFIG_HEALBOOST_INFO	= "Die Prozent an extra Gesundheit, welche beim Intelligenten Heilen nach Rang geheilt werdensollen.";
	...
	CASTOPTIONS_CONFIG_RIGHTSELF		= "Rechts-Klick Selbstzaubern";
	CASTOPTIONS_CONFIG_RIGHTSELF_INFO	= "Wenn aktiviert, wird ein Zauber auf einen selbst gezaubert wenn ein Buttom in der Aktionsleiste mit der rechten Maustaste angeklickt wird.";
	...
	CASTOPTIONS_CONFIG_GROUPBLESSING	= "Intelligentes Gruppensegnen";
	CASTOPTIONS_CONFIG_GROUPBLESSING_INFO	= "Wenn aktiviert, wird intelligentes Gruppensegnen verwendet. Bitte die Hilfe f\195\188r Details zur Verwendung lesen.";
	...
	CASTOPTIONS_CHAT_TEXTURE		= "Icon Anzeige";
	CASTOPTIONS_CHAT_TEXTURE_INFO		= "Wenn aktiviert, wird das Icon des Zaubers, welcher gerade ausgef\195\188hrt wurde, angezeigt.";
	CASTOPTIONS_CHAT_LINK			= "Link-ID des Gegenstandes Anzeige";
	CASTOPTIONS_CHAT_LINK_INFO		= "Wenn aktiviert, wird die Link-ID bei der Verwendung eines Gegenstandes angezeigt.";
