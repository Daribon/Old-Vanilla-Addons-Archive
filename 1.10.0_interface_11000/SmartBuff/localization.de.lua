...
SMARTBUFF_DRUID[2] = {"Dornen", 10, SMARTBUFF_CONST_GROUP, {6,14,24,34,44,54}, "MAGE;PRIEST;WARLOCK;WPET"};
SMARTBUFF_DRUID[3] = {"Omen der Klarsicht", 10, SMARTBUFF_CONST_SELF};
SMARTBUFF_DRUID[4] = {"Baumrinde", 0.25, SMARTBUFF_CONST_SELF};
SMARTBUFF_DRUID[5] = {"Griff der Natur", 0.75, SMARTBUFF_CONST_SELF};
...
SMARTBUFF_ROGUE[2]  = {"Entrinnen", 0.2, SMARTBUFF_CONST_SELF};
SMARTBUFF_ROGUE[3]  = {"Sofort wirkendes Gift VI", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[4]  = {"Sofort wirkendes Gift V", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[5]  = {"Sofort wirkendes Gift IV", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[6]  = {"Sofort wirkendes Gift III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[7]  = {"Sofort wirkendes Gift II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[8]  = {"Sofort wirkendes Gift", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[9] = {"Wundgift IV", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[10] = {"Wundgift III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[11] = {"Wundgift II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[12] = {"Wundgift", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[13] = {"Gedankenbenebelndes Gift III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[14] = {"Gedankenbenebelndes Gift II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[15] = {"Gedankenbenebelndes Gift", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[16] = {"T\195\182dliches Gift IV", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[17] = {"T\195\182dliches Gift III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[18] = {"T\195\182dliches Gift II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[19] = {"T\195\182dliches Gift", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[20] = {"Verkr\195\188ppelndes Gift II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[21] = {"Verkr\195\188ppelndes Gift", 30, SMARTBUFF_CONST_INV};
...
SMARTBUFF_PALADIN[5]  = {"Segen der Opferung", 5, SMARTBUFF_CONST_GROUP, {26}, "SHAMAN;WARRIOR;HPET;WPET", "Gro\195\159er Segen des Refugiums", 15, {60}, {"Symbol der K\195\182nige"} };
...
SMARTBUFF_PALADIN[7]  = {"Segen der Rettung", 5, SMARTBUFF_CONST_GROUP, {30,40,50,60}, "DRUID;HUNTER;MAGE;PRIEST;ROGUE;SHAMAN;WARLOCK;HPET;WPET", "Gro\195\159er Segen der Rettung", 15, {60}, {"Symbol der K\195\182nige"} };
