...
function TooltipsEliteTarget_OnLoad()
	...
	Sea.util.hook("TargetFrame_Update","TooltipsEliteTarget_TargetFrame_Update","after");
    Sea.util.hook("TooltipsBase_UnitHandler","TooltipsEliteTarget_UnitHandler","after");
end