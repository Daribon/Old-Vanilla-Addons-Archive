...
function TitanMovableFrame_CheckFrames(position)
	...
	if (position == TITAN_PANEL_PLACE_TOP) then
		panelYOffset = TitanMovable_GetPanelYOffset(TITAN_PANEL_PLACE_TOP);
	...
	elseif (position == TITAN_PANEL_PLACE_BOTTOM) then
		panelYOffset = TitanMovable_GetPanelYOffset(TITAN_PANEL_PLACE_BOTTOM);
...
--		TitanDebug(frameName..":SetPoint("..frameArchor..", UIParent, "..frameArchor..", "..xOffset..", "..yOffset..")");
