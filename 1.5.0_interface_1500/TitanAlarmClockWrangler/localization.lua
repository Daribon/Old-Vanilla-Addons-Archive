...
elseif (GetLocale() == "deDE") then
	...
	ACW_OFFSET_ERROR = "Der Versatz für Zankender Wecker muß zwischen -12 und +12 liegen";
	ACW_RESET = "Einstellungen vom zankenden Wecker zurückgesetzt...";
	ACW_UNKNOWN = "Zankender Wecker:  Unbekannter Befehl.  Gebe /acw help für eine Liste gültiger Befehle ein.";
	...
	ACW_ACKNOWLEDGED = "bestätigt...";
	ACW_SNOOZE_BUTTON = "Schlummerknopf";
	ACW_ACKNOWLEDGE_ALARMS_BUTTON = "Bestätige Weckruf(e)";
	...
	ACW_ERROR_ALARMTIME = "FEHLER: Ungültige Weckzeit!";
	ACW_ERROR_ALARMMESSAGE = "FEHLER: Ungültige Wecknachricht!";
	ACW_ERROR_SNOOZEMESSAGE = "FEHLER: Ungültige Schlummerzeit!";
