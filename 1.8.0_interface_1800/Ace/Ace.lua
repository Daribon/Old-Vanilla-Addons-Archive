...
local ACE_VERSION		= "1.2.5"
local ACE_COMP_VERSION	= 102
local ACE_RELEASE		= "10-11-2005"
...
function Ace:RegisterAddon(app)
	if( myAddOnsList ) then
		myAddOnsList[app.name] = {
			name		 = app.name,
			description  = app.description,
			version		 = app.version,
			category	 = getglobal("ACE_CATEGORY"..(app.category or "OTHERS")) or
						   ACE_CATEGORY_OTHERS,
			frame		 = "TRUE",
