...
local item_types = {
	...
	["food"] = {
		...
		{"item:4604", 61},	-- Vendor  - Level 1, heals 61
		{"Bean Soup", 61},		-- Vendor  - Level 1, heals 61
		{"item:9681", 61},		-- "Charred Wolf Meat",	-- Cooking - Level 1, heals 61
		{"Roasted Boar Meat", 61},	-- Cooking - Level 1, heals 61
		{"Slitherskin Mackerel", 61},	-- Cooking - Level 1, heals 61
		{"item:6291", 61},	-- Cooking - Level 1, heals 61
		...
		{"Crispy Bat Wing", 61, 1},	-- Cooking - Level 1, heals 61, with bonus
		{"Gingerbread Cookie", 61, 1},	-- Cooking - Level 1, heals 61, with bonus
		{"Egg Nog", 61, 1},		-- Cooking - Level 1, heals 61, with bonus
		{"Kaldorei Spider Kabob", 61, 1},-- Cooking - Level 1, heals 61, with bonus
		{"Beer Basted Boar Ribs", 61, 1},-- Cooking - Level 1, heals 61, with bonus
		{"Roasted Kodo Meat", 61, 1},	-- Cooking - Level 1, heals 61, with bonus
		{"item:11583", 61, 1},-- Quest   - Level 1, heals 61, with bonus
		{"Versicolor Treat", 243},	-- Vendor  - Level 5, heals 243
		...
		{"Smoked Bear Meat", 243},	-- Cooking - Level 5, heals 243
		{"Lock Frenzy Delight", 243},	-- Cooking - Level 5, heals 243
		...
		{"Coyote Steak", 243, 1},		-- Cooking
		{"item:5525", 243, 1},		-- "Boiled Clams",		-- Cooking
		{"Fillet of Frenzy", 243, 1},	-- Cooking - Level 5, heals 243, with bonus
		{"item:5477", 243, 1},		-- Strider Stew Cooking - Level 5, heals 243, with bonus
		{"Goretusk Liver Pie", 243, 1},	-- Cooking - Level 5, heals 243, with bonus
		{"Blood Sausage", 243, 1},	-- Cooking - Level 5, heals 243, with bonus
		{"Crocolisk Steak", 243, 1},	-- Cooking - Level 5, heals 243, with bonus
		...
		{"item:8076", 2148, 0},	-- Mage    - Level 45, heals 2148
	}
}
...
function GAutoBar_Init()
	...
	if (eng_class == "WARRIOR" or eng_class == "KRIEGER") then
		item_types["mana"] = alt_types["rage"]
		item_types["water"] = nil
	elseif (eng_class == "ROGUE" or eng_class == "SCHURKE") then
...
function GetGAutoBarActionCooldown(id)
    local item = getglobal("GAutoBarButton"..id);
    if (item.bag and item.slot) then
        local start, duration, enable = GetContainerItemCooldown(item.bag, item.slot)
...
function GAutoBar_ButtonUp(id)
	...
	if (button:GetButtonState() == "PUSHED") then
		...
		MacroFrame_EditMacro()	-- apparently this is to save the macro being edited before performing another action
