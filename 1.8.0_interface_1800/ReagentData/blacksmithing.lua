...
ReagentData['crafted']['blacksmithing'] = {
	...
	skill = 265,
        type = 'Plate',
        source = 'Unknown:Plans: Imperial Plate Belt',
        sourcerarity = 'Uncommon',
        result = 1,
        resultrarity = 'Uncommon',
        reagents = {
	...
	skill = 225,
        type = 'Plate',
        source = 'Unknown:Plans: Ornate Mithril Shoulder',
        sourcerarity = 'Uncommon',
        result = 1,
    ...
    ['Ebon Hand'] = {
	 type = 'Mace',
	 description = '[BoE] (OH Mace) Dmg: 83-154, Spd: 2.30, DPS: 51.5, Sta: 9, FR: 7, MinLvl: 60, Chance On Hit: Sends a shadowy bolt at the enemy causing 125 to 275 Shadow damage.',
	 source = 'Vendor:Plans: Ebon Hand',
	 result = 1,
	 resultrarity = 'Epic',
	 reagents = {
	      [ReagentData['monster']['lavacore']] = 8,
	      [ReagentData['monster']['fierycore']] = 14,
	      [ReagentData['bar']['arcanite']] = 12,
    ...
    ['Nightfall'] = {
	 type = 'Two-Hand Axe',
	 description = '[BoE] (2H Mace) Dmg: 171-258, Spd: 3.20, DPS: 67.0, MinLvl: 60, Chance On Hit: Reduces enemy\'s spell resistances by 60 for 5 seconds.',
	 source = 'Vendor:Plans: Nightfall',
	 result = 1,
	 resultrarity = 'Epic',
	 reagents = {
	      [ReagentData['monster']['lavacore']] = 16,
	      [ReagentData['monster']['fierycore']] = 10,
	      [ReagentData['bar']['arcanite']] = 10,
    ...
    ['Darkrune Gauntlets'] = {
	 ...
	 source = 'Vendor:Plans: Darkrune Gauntlets',
	 result = 1,
	 resultrarity = 'Rare',
	 reagents = {
	      [ReagentData['bar']['thorium']] = 12,
    ...
    ['Darkrune Heml'] = {
	 ...
	 type = 'Unknown',
	 description = 'Unknown',
	 source = 'Vendor:Plans: Darkrune Helm',
	 result = 1,
	 resultrarity = 'Unknown',
	 reagents = {
	      [ReagentData['bar']['thorium']] = 16,
    ...
    ['Darkrune Breastplate'] = {
	 ...
	 source = 'Vendor:Plans: Darkrune Breastplate',
	 result = 1,
	 resultrarity = 'Rare',
	 reagents = {
	      [ReagentData['bar']['thorium']] = 20,
