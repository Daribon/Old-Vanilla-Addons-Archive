--[[
	...
	$Id: CooldownCount.lua 2678 2005-10-21 16:58:54Z sarf $
	$Rev: 2678 $
	$LastChangedBy: sarf $
	$Date: 2005-10-21 11:58:54 -0500 (Fri, 21 Oct 2005) $
...
function CooldownCount_OnEvent(event)
	...
	if ( event == "VARIABLES_LOADED" ) then
		...
		if ( CooldownCount_RogueStealth == 1 ) or ( class ~= COOLDOWNCOUNT_CLASS_ROGUE ) then
...
function CooldownCount_Toggle_Enabled(toggle)
	...
	if ( newvalue ~= oldvalue and not Khaos) then
		if ( newvalue == 1 ) then
