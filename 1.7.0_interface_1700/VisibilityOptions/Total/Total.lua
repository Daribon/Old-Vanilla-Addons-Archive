--[[
	...
	$Id: Total.lua 2177 2005-07-28 01:26:55Z mugendai $
	$Rev: 2177 $
...
Eclipse.Total.registerForHide = function ( reglist )
	...
	if (Eclipse.Total.Initialized ~= 1) then
		--Register our configuration variable to be saved
		RegisterForSave("Total_Config");
		RegisterForSave("Total_Storage");
		Eclipse.Total.Initialized = 1;
	end
