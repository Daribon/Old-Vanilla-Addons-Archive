...
For example: Here's your cloth [Runecloth x20]

The body text will show items #x of #y for however many you send. (#1 of 14)

The total amount for sending all mails will be calculated into the upper right of the window, and a confirmation box will ensure you know.  Each mail will have a 2-4 second delay between sends, based on your latency.
