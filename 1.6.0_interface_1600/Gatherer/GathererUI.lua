--[[
	...
	Version: <%version%>
	Revision: $Id: GathererUI.lua,v 1.15 2005/07/15 20:12:58 islorgris Exp $
...
function GathererUI_InitializeOptions()
	...
	elseif ( GatherConfig.showWorldMapFilters == 1 ) then
		...
		GathererWD_DropDownHerbs:Hide();
		GathererWD_DropDownOre:Hide();
		GathererWD_DropDownTreasure:Hide()
	end
	
	if ( GatherConfig.disableWMFreezeWorkaround ) then
...
function GathererUIDropDownHerbs_Initialize()
	...
	UIDropDownMenu_SetText(value, GathererWD_DropDownHerbs);
...
function GathererUIDropDownOre_Initialize()
	...
	UIDropDownMenu_SetText(value, GathererWD_DropDownOre);
...
function GathererUIDropDownTreasure_Initialize()
	...
	UIDropDownMenu_SetText(value, GathererWD_DropDownTreasure);
