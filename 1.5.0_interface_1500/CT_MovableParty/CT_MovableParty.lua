...
CT_AddMovable("CT_MovableParty1_Drag", "Party member 1", "TOPLEFT", "TOPLEFT", "UIParent", 50, -131, function(status)
...
CT_AddMovable("CT_MovableParty2_Drag", "Party member 2", "TOPLEFT", "TOPLEFT", "CT_MovableParty1_Drag", 0, -63, nil, function()
	if ( CT_BarMod_SidebarMoved and CT_CheckLSidebar ) then
		CT_MovableParty.reset = 0.1;
	end
end);

CT_AddMovable("CT_MovableParty3_Drag", "Party member 3", "TOPLEFT", "TOPLEFT", "CT_MovableParty2_Drag", 0, -63, nil, function()
	if ( CT_BarMod_SidebarMoved and CT_CheckLSidebar ) then
		CT_MovableParty.reset = 0.1;
	end
end);

CT_AddMovable("CT_MovableParty4_Drag", "Party member 4", "TOPLEFT", "TOPLEFT", "CT_MovableParty3_Drag", 0, -63, nil, function()
	if ( CT_BarMod_SidebarMoved and CT_CheckLSidebar ) then
		CT_MovableParty.reset = 0.1;
	end
end);
