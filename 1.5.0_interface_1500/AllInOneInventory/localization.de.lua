if (GetLocale()=="deDE") then
	...
	-- Translation by : DocVanGogh
	
	BINDING_HEADER_ALLINONEINVENTORYHEADER				= "Komplettinventar";
	BINDING_NAME_ALLINONEINVENTORY						= "Komplettinventar ein-/ausschalten";
	...
	ALLINONEINVENTORY_CHAT_COMMAND_INFO					= "Steuert Komplettinventar per Kommandozeile - /allinoneinventory f\195\188r Gebrauchsanweisung.";
	
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[1] = "Gebrauch: /allinoneinventory [toggle/includeshotbags/replacebags/reset/columns]";
	...
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[4] = " includeshotbags - ob Munitionsbeutel enthalten sein sollen, oder nicht";
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[5] = " reset - setzt das Fenster an seine Ursprungsposition zur\195\188ck";
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[6] = " replacebags - obe die Standardtaschen ersetzt werden sollen.";
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[7] = " columns - wieviele Spalten pro Zeile angezeigt werden sollen";
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[8] = " togglebags - toggle bag number or the backpack";
	...
	ALLINONEINVENTORY_CHAT_NO_SUCH_BAGNUMBER			= "Taschennummer nicht erkannt: 0 steht f\195\188r den Rucksack, 1-4 f\195\188r die entsprechenden Taschen.";
