...
function Gypsy_PartyFrameUpdateBindingLabels()
	...
	if (Gypsy_ShowPartyBindingLabels == 1) then
		label:SetText(KeyBindingFrame_GetLocalizedName(GetBindingKey(binding), "KEY_"));
	else
		label:SetText("");
	end
end
