...
AtlasText = {
	...
	ZulGurub = {
		...
		GREY.."1) High Priestess Jeklik";
		GREY.."2) High Priest Venoxis";
		GREY.."3) High Priestess Mar'li";
		...
		GREY.."6) Gahz'ranka";
		GREY.."7) High Priest Thekal";
		GREY.."8) High Priestess Arlokk";
		GREY.."9) Jin'do the Hexxer";
		GREY.."10) Hakkar";
	}
};
