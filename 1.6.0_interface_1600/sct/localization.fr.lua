...
if ( GetLocale() == "frFR" ) then
    ...
    SCT_BlockMsg = "Bloqu\195\169 !";   	-- Message to be displayed when you block
    SCT_MissMsg = "Cible Rate !";       	-- Message to be displayed when you are missed
    SCT_ResistMsg = "Resist\195\169 !"; 	-- Message to be displayed when you resist
    ...
    SCT_ComboPoint = "Pts de Combo";    	-- Message to be displayed when gaining a combo point
    ...
    SCT_YOU = "Vous";
    SCT_TARGET = "Cible";
    SCT_AFFLICTED_BY = "Vous \195\170tes afflig\195\169s par ";
    ...
    --Event and Damage option values
		...
		SCT_OPTION_EVENT9 = {name = "Montrer Debuffs", tooltipText = "Activer/D\195\169sactiver l\'affichage lorsque vous êtes debuffs"};
		...
		SCT_OPTION_EVENT17 = {name = "Montrer Buffs", tooltipText = "Activer/D\195\169sactiver l\'affichage lorsque vous êtes buffs"};
