...
if ( GetLocale() == "deDE" ) then
	...
	COOLDOWNCOUNT_ROGUE_STEALTH				= "Abklingzeit der Tarnung von Schurken";
	COOLDOWNCOUNT_ROGUE_STEALTH_INFO			= "Aktiviert den Abklingzeit Z\195\164hler der Tarnung von Schurken.";
	...
	COOLDOWNCOUNT_CHAT_ROGUE_STEALTH_ENABLED		= "Abklingzeit Z\195\164hler: Schurken Tarnung aktiviert.";
	COOLDOWNCOUNT_CHAT_ROGUE_STEALTH_DISABLED		= "Abklingzeit Z\195\164hler: Schurken Tarnung deaktiviert.";
