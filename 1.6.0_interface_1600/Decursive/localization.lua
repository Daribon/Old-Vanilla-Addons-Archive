...
-------------------------------------------------------------------------------
DCR_VERSION_STRING = "Decursive 1.1.6";
...
BINDING_NAME_RBCLEAN = "Clean Group";
DCR_MACRO_ERROR      = "Please run '/decursive' without any parameters";
...
if ( GetLocale() == "deDE" ) then
	...
	BINDING_NAME_RBCLEAN = "Reinige Gruppe";
	DCR_MACRO_ERROR = "'/decursive' bitte ohne Parameter starten";
...
-------------------------------------------------------------------------------
-- French localization
-- Incomplete... I need the "strings" translated
-------------------------------------------------------------------------------
elseif ( GetLocale() == "frFR" ) then
	...
	BINDING_NAME_RBCLEAN     = "Nettoyage des poisons et maledictions";
	DCR_MACRO_ERROR    = "d\195\169marrer /decursive sans parametres";
