...
local myCPProfile_DoScanInventory 	= 	1;	-- get inventory?
local myCPProfile_DoScanBank 		= 	1;	-- get bank?
local myCPProfile_DoScanEquipment 	= 	1;	-- get equipment?
local myCPProfile_DoScanSkills 		=  	1;	-- get skills?
local myCPProfile_DoScanTalents 	= 	1;	-- get talents?
local myCPProfile_DoScanProfessions	= 	1;	-- output known tradeskill recipies
local myCPProfile_DoScanReputation	=	1;	-- get reputation?
local myCPProfile_DoScanQuestLog	=	1;	-- get quests?
local myCPProfile_DoScanHonor		=	1;	-- get honor?
...
function CP_ProfileFrame_OnEvent(event, arg1, arg2)
	...
	if ( ( event == "UNIT_INVENTORY_CHANGED" and arg1 ~= "player" ) or not myCPProfile_ENABLED or not UnitName("player") or UnitName("player") == UNKNOWNOBJECT or not GetCVar("realmName")) then
		return;
	end
...
--	local displayMax = ceil(maxDamage + totalBonus);
	...
	CP_ProfHidden:AddDoubleLine(ATTACK_SPEED_COLON, format("%.2f", CharacterDamageFrame.attackSpeed), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
	...
	CP_ProfHidden:AddDoubleLine(DAMAGE_PER_SECOND, format("%.1f", CharacterDamageFrame.dps), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
	...
	if ( CharacterDamageFrame.offhandAttackSpeed ) then
		...
		CP_ProfHidden:AddDoubleLine(ATTACK_SPEED_COLON, format("%.2f", CharacterDamageFrame.offhandAttackSpeed), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
		...
		CP_ProfHidden:AddDoubleLine(DAMAGE_PER_SECOND, format("%.1f", CharacterDamageFrame.offhandDps), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
	end
	...
	if ( PaperDollFrame.noRanged ) then
		...
		CP_ProfHidden:AddDoubleLine(ATTACK_SPEED_COLON, format("%.2f", CharacterRangedDamageFrame.attackSpeed), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
		...
		CP_ProfHidden:AddDoubleLine(DAMAGE_PER_SECOND, format("%.1f", CharacterRangedDamageFrame.dps), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
...
function Profile_ScanHonor()
	...
	if ( rankNumber > 0 ) then
		rankIcon = format("%s%02d","Interface\\PvPRankBadges\\PvPRank", rankNumber);
	end
...
function Profile_ScanTradeSkill()
	...
	--CensusPlus_Profile[GetCVar("realmName")][UnitName("player")]["Professions"][skillLineName]["Rank"] = skillLineRank .. ":" ..skillLineMaxRank;
