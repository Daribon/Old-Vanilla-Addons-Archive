***********************************
Scrolling Combat Text Versions 3.1
***********************************
...
Version History
3.1 - Added Buff event, mana drains, New German Translations, Cosmos 2 Button support. Please note there are some new messages in the combat log from the 1.6 patch that are causing anomolies in SCT right now.
