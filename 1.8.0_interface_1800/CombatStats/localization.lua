-- <= == == == == == == == == == == == == =>
-- Combat Stats Localization file
-- <= == == == == == == == == == == == == =>
...
CS_TB_MENU_TEXT="CombatStats"
CS_TB_BUTTON_TEXT = "DPS : %.2f / %.2f";
...
CS_1		= "(.+) suffers (%d+) (.+) damage from your (.+).";
CS_2		= "Your (.+) hits (.+) for (%d+).";
CS_3		= "You hit (.+) for (%d+)";
CS_4		= "Your (.+) crits (.+) for (%d+).";
CS_5		= "You crit (.+) for (%d+)";
CS_6		= "You miss (.+).";
CS_7		= "You attack. (.+) parries.";
CS_8		= "You attack. (.+) evades.";
CS_9		= "You attack. (.+) dodges.";
CS_10		= "You attack. (.+) deflects.";
CS_11		= "You attack. (.+) blocks.";
CS_12		= "Your (.+) was blocked by (.+).";
CS_13		= "Your (.+) was deflected by (.+).";
CS_14		= "Your (.+) was dodged by (.+).";
CS_15		= "Your (.+) was evaded by (.+).";
CS_16		= "Your (.+) is parried by (.+)";
CS_17		= "Your (.+) was resisted by (.+).";
CS_18		= "Your (.+) failed. (.+) is immune.";
CS_19		= "Your (.+) missed (.+).";
CS_20		= "(.+) crits (.+) for (%d+).";
CS_21		= "(.+) hits (.+) for (%d+).";
CS_22		= "(.+)'s (.+) hits (.+) for (%d+).";
CS_23		= "(.+)'s (.+) crits (.+) for (%d+).";
CS_24		= "(.+)'s (.+) was blocked by (.*).";
CS_25		= "(.+)'s (.+) was dodged by (.*).";
CS_26		= "(.+)'s (.+) was evaded by (.*).";
CS_27		= "(.+)'s (.+) fails. (.+) is immune.";
CS_28		= "(.+)'s (.+) was resisted by (.*).";
CS_29		= "(.+)'s (.+) misses (.*).";
CS_30		= "(.+)'s (.+) missed (.*).";
CS_31		= "(.+)'s (.+) failed. (.+) is immune.";
CS_32		= "(.+)'s (.+) missed (.+).";
CS_33		= "(.+)'s (.+) was deflected by (.+).";
CS_34		= "(.+) misses (.*).";
CS_35		= "(.+) attacks. (.+) parries.";
CS_36		= "(.+) attacks. (.+) evades.";
CS_37		= "(.+) attacks. (.+) dodges.";
CS_38		= "(.+) attacks. (.+) deflects.";
CS_39		= "(.+) attacks. (.+) blocks.";
CS_40		= "(.+) hits you for (%d+). (.+) blocked";
CS_41		= "(.+) hits you for (%d+)";
CS_42		= "(.+) crits you for (%d+).";
CS_43		= "(.+)'s (.+) hits you for (%d+).";
CS_44		= "(.+)'s (.+) crits you for (%d+).";
CS_45		= "(.+)'s (.+) was blocked%.";
CS_46		= "(.+)'s (.+) was deflected%.";
CS_47		= "(.+)'s (.+) was dodged%.";
CS_48		= "(.+)'s (.+) was evaded%.";
CS_49		= "(.+)'s (.+) failed. You are immune.";
CS_50		= "(.+)'s (.+) misses you.";
CS_51		= "You parry (.+)'s (.+)";
CS_52		= "(.+)'s (.+) was resisted%.";
CS_53		= "(.+) misses you.";
CS_54		= "(.+) attacks. You parry.";
CS_55		= "(.+) attacks. You evade.";
CS_56		= "(.+) attacks. You dodge.";
CS_57		= "(.+) attacks. You deflect.";
CS_58		= "(.+) attacks. You block.";
