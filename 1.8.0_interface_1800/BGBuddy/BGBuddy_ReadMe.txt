-=-=-=-=-=-=-=-=-=-=-=-=-=-
=                         =
= BGBuddy v1.55           = by Conflictus (Illidan Alliance)
=                         = 
-=-=-=-=-=-=-=-=-=-=-=-=-=-
...
-> A "buddy" list module so you can monitor your friends'
   statistics within the Battleground as well
-> Option to Auto-Disband upon exiting the Battleground
-> A Tower and Graveyard "Time Until Capture" module
-> A complete CTF module for Warsong Gulch
-> TitalPanel support
-> InfoBar support
...
- HISTORY
------------------------------------------------------------
+ Version 1.55					06/29/2005
  -> Fixed bug that could have been causing disconnects for
     dial-up users
  -> Fixed bug with customized display settings
  -> Fixed bug with Auto-Join/Auto-Res/Auto-Release not
     always remembering saved settings
