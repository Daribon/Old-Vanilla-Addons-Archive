...
ONEHITWONDER_HUNTER_WING_CLIP_HEALTH						= "Wing Clip at health %";
ONEHITWONDER_HUNTER_WING_CLIP_HEALTH_INFO					= "Tells OHW to try to Wing Clip the enemy when their health is below the specified percentage.";
ONEHITWONDER_HUNTER_WING_CLIP_HEALTH_APPPEND				= "%";
