...
elseif( ThisRealmName == "Wildhammer" ) then
	PropsCoderTooltips = {
		...
		["Aparition"] = "In what way would you like to die?";
		["Prizm"] = "Rogues do it from behind";
...
elseif( ThisRealmName == "Nathrezim" ) then
	PropsCoderTooltips = {
		...
		["Odus"] = "This hour is inevitable. I am... A MACHINE!";
		...
		["Penguina"] = "ass...";
		["Qcdreadhead"] = "desolee, c\'est un erruer";
		["Karim"] = "I see undead people.";
		["Ralpok"] = "NERF SHAMANS!!  LOL";
		["Zubazz"] = "oh brother, where art thou?";
		["Dignan"] = "Dig this.";
		["Sweeterika"] = "I\'m sweet but I like it rough.";
		["Goshinki"] = "i can't think of something clever";
		["Jekni"] = "yarrr";
		["Twistar"] = "Pirates vs Ninjas: Who wins?";
		["Zulejah"] = "         ... peanut butter...";
		["Amatine"] = "Don\'t get any funny ideas "..UnitName("Player").."...";
	};
