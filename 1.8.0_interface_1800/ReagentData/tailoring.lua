...
ReagentData['crafted']['tailoring'] = {
    ...
    ['Dreamweave Circlet'] = {
        skill = 250,
        description = '[BoE] (Cloth Head) AC: 53, Int: 6, Spi: 12, MinLvl: 45, Equip: Increases damage and healing done by magical spells and effects by up to 9.',
        type = 'Cloth',
        source = 'Trainer',
        result = 1,
        resultrarity = 'Uncommon',
    ...
    ['Gloves of Spell Mastery'] = {
        ...
        type = 'Cloth',
        source = 'Unknown:Pattern: Gloves of Spell Mastery',
        sourcerarity = 'Epic',
        result = 1,
        resultrarity = 'Epic',
        reagents = {
    ...
    ['Runed Stygian Boots'] = {
	 skill = 300,
	 description = '[BoE] (Cloth Feet) Unknown Stats',
	 type = 'Cloth',
	 source = 'Drop:Pattern: Runed Stygian Boots',
	 sourcerarity = 'Unknown',
	 result = 1,
