...
CT_TIMER_DRAG2 = "Right-click to drag.";
...
CT_TIMER_FINISHCOUNT = "The timer has finished counting down (counted from '<time>')";
...
CT_TIMER_SUBNAME = "On/Off Toggle";
CT_TIMER_TOOLTIP = "Toggles the timer mod on/off.";
