CensusPlus - by Rollie of Bloodscalp aka Cooper Sellers
  ...
  INTRODUCTION
    ...
    UI mod provided.  Here follows a list of added features:
        ...
        -  Abilty to minimize the main census window
            ...
            is being taken
        -  Ability for the Friends panel to be automatically closed after
        ...
        -  Added a /censusdate command which allows the user to place a
        ...
        -  GameTime timestamp added when characters are viewed which will be 
            used by www.warcraftrealms.com if your data is uploaded
  ...
  USAGE
    ...
    You can set the current date by typing /censusdate MM-DD-YYYY, for example typing
        /censusdate 12-25-2004 would set the current date to December 25, 2005.
        
    You can select to automatically close the Friends panel when it pops open
    when a /who command is executed.
