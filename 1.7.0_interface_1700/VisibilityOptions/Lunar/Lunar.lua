--[[
	...
	$Id: Lunar.lua 2177 2005-07-28 01:26:55Z mugendai $
	$Rev: 2177 $
...
Eclipse.Lunar.registerForAutohide = function ( reglist )
	...
	if (Eclipse.Lunar.Initialized ~= 1) then
		--Register our configuration variable to be saved
		RegisterForSave("Lunar_Config");
		RegisterForSave("Lunar_Storage");
		Eclipse.Lunar.Initialized = 1;
	end
