...
WARDROBE_NAME_LABEL         = "Name Your Current Outfit";

WARDROBE_PLAGUEBUTTON_TIP1   = "Wear the selected outfit\nwhen you enter the\nPlaguelands.";
WARDROBE_MOUNTBUTTON_TIP1    = "Wear the selected outfit\nwhen you mount.";
WARDROBE_EATDRINKBUTTON_TIP1 = "Wear the selected outfit\nwhen you are eating\nor drinking.";
...
WARDROBE_TXT_OK                     = "OK";
WARDROBE_TXT_WPLAGUELANDS           = "Western Plaguelands";
WARDROBE_TXT_EPLAGUELANDS           = "Eastern Plaguelands";
WARDROBE_TXT_STRATHOLME             = "Stratholme";
WARDROBE_TXT_SCHOLOMANCE            = "Scholomance";
...
WARDROBE_TXT_WILLBEWORNWHENMOUNTED  = "will be worn when mounted.";
...
WARDROBE_TXT_MOUNTEDNOTEXIST        = "That outfit doesn't exist.  Please enter an existing outfit to use when mounted.";
WARDROBE_TXT_ERRORINCONFIG          = "Error in Wardrobe_ShowWardrobeConfigurationScreen: Wardrobe_Config.DefaultCheckboxState has unknown value of ";
WARDROBE_TXT_CHANGECANCELED         = "Wardrobe change canceled!";
WARDROBE_TXT_NEWOUTFITNAME          = "New Outfit Name";
WARDROBE_TXT_NOLONGERWORNMOUNTERR   = "will no longer be worn when you mount.";
WARDROBE_TXT_WORNWHENMOUNTERR       = "will now be worn when you mount.";
WARDROBE_TXT_NOLONGERWORNPLAGUEERR  = "will no longer be worn when you are in the Plaguelands.";
WARDROBE_TXT_WORNPLAGUEERR          = "will now be worn when you are in the Plaguelands.";
WARDROBE_TXT_NOLONGERWORNEATERR     = "will no longer be worn when you are eating / drinking.";
WARDROBE_TXT_WORNEATERR             = "will now be worn when you are eating / drinking.";
