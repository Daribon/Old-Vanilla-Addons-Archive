...
function MonkeySpeed_OnLoad()
	MonkeySpeedFrame:SetBackdropColor(0, 0, 0, transparency);
	MonkeySpeedFrame:SetBackdropBorderColor(1, 1, 1, 1); --[[ mark ]]--
	if ( UltimateUI_RegisterConfiguration ) then
		...
		UltimateUI_RegisterConfiguration(
			...
			UltimateUI_RegisterConfiguration(
				"UUI_MSPEED_ENABLE",   -- registered name
				"BUTTON",													-- register type
				"Toggle MonkeySpeed",								-- short description
				"Toggling this shows/hides MonkeySpeed.",						-- long description
				MonkeySpeed_ToggleDisplay,										-- function
				0,						-- useless
				0,						-- useless
				0,						-- useless
				0,						-- useless
			...
			UltimateUI_RegisterConfiguration(
				"UUI_MSPEED_PERCENT",   -- registered name
				"BUTTON",													-- register type
				"Toggle Percent",								-- short description
				"Toggle this shows/hides the percent value on MonkeySpeed.",						-- long description
				MonkeySpeed_TogglePercent,										-- function
				0,						-- useless
				0,						-- useless
				0,						-- useless
				0,						-- useless
			...
			UltimateUI_RegisterConfiguration(
				"UUI_MSPEED_BAR",   -- registered name
				"BUTTON",													-- register type
				"Toggle Bar",								-- short description
				"Toggle the bar of MonkeySpeed",						-- long description
				MonkeySpeed_ToggleBar,										-- function
				0,						-- useless
				0,						-- useless
				0,						-- useless
				0,						-- useless
			...
			UltimateUI_RegisterConfiguration(
				"UUI_MSPEED_LOCK",   -- registered name
				"BUTTON",													-- register type
				"Toggle Lock",								-- short description
				"Toggle the locking of MonkeySpeed",						-- long description
				MonkeySpeed_ToggleLock,										-- function
				0,						-- useless
				0,						-- useless
				0,						-- useless
				0,						-- useless
			...
			UltimateUI_RegisterConfiguration(
				"UUI_MSPEED_DEBUG",   -- registered name
				"BUTTON",													-- register type
				"Toggle Debug Mode",								-- short description
				"Toggle the debug mode of MonkeySpeed",						-- long description
				MonkeySpeed_ToggleDebug,										-- function
				0,						-- useless
				0,						-- useless
				0,						-- useless
				0,						-- useless
	...
	MonkeySpeedFrame:SetBackdropBorderColor(1, 1, 1, 1);
end
