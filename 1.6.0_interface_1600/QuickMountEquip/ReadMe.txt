...
VERSION
 ...
 2.12 - 2005/02/26
	...
	Added optional check for Sea.util.hook for the new UltimateUI Alpha.
	Changed .zip to include full Interface\AddOns\QuickMountEquip path.
	Added Interface\AddOns\QuickMountEquip.nopatch for UltimateUI users.
 ...
 2.02 - 2005/01/25
	...
	Removed the need for UltimateUI.

 2.00 - 2005/01/24

	Initial public release. Required UltimateUI.
...
/mountequip - This is the main interface to the configuration options.
	...
	There are several options available: on, off, quiet, verbose, flightpoint, config, status, load, save, delete, profiles
