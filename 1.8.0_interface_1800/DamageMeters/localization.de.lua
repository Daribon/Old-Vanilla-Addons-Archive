...
if ( GetLocale() == "deDE" ) then
	...
	function DamageMeters_GetClassColor(className)
		...
		-- for the German word for hunter.
		if ("J" == string.sub(className, 1, 1)) then
			return RAID_CLASS_COLORS["HUNTER"];
		else
			return RAID_CLASS_COLORS[ DamageMeters_classTranslationTable[string.upper(className)] ];
		end
	end
