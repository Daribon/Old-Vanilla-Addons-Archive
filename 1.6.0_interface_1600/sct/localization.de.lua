...
if ( GetLocale() == "deDE" ) then
		...
		SCT_YOU		= "Du ";
		SCT_TARGET	= "Ziel ";
		SCT_AFFLICTED_BY= "Du bist betroffen von ";
		SCT_PROFILE = "SCT Profil geladen: |cff00ff00";  --***Needs Translation***
	
		--Search Messages
		SCT_ABSORB_AMOUNT_SEARCH		= "Schaden: (%d+) (.+)";
		SCT_BLOCK_AMOUNT_SEARCH			= "Schaden (%d+). (.+)";
		SCT_DEBUFF_NAME_SEARCH			= "Du bist von (.+) betroffen.";
		SCT_YOU_GAIN_AMOUNT_SEARCH		= "Du (%w+) (%d+) (%w+)";
		SCT_YOU_GAIN_SEARCH = "Du bekommst (.+).";
		SCT_HONOR_SEARCH = "Estimated Honor Points: (%d+)"; --***Needs Translation***
		...
		SCT_OPTION_EVENT17 = {name = "Stärkungszauber anzeigen", tooltipText = "Aktiviert die Anzeige von Stärkungszauber"};
