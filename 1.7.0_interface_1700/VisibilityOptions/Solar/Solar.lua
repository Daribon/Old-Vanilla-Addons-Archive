--[[
	...
	$Id: Solar.lua 2177 2005-07-28 01:26:55Z mugendai $
	$Rev: 2177 $
...
Eclipse.Solar.registerForTransparency = function ( reglist )
	...
	--If we aren't yet initialized then initialize
	if (Eclipse.Solar.Initialized ~= 1) then
		--Register our configuration variable to be saved
		RegisterForSave("Solar_Config");
		RegisterForSave("Solar_Storage");
		Eclipse.Solar.Initialized = 1;
	end
