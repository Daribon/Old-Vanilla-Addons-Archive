...
function OneHitWonder_Shaman_ScanWeapon()
	OneHitWonder_Shaman_WeaponScannedAtTime = nil;
	OneHitWonder_Shaman_DoKeepUpWeaponBuff();
end
...
function OneHitWonder_Shaman_DoKeepUpWeaponBuff(canCast)
	...
	return OneHitWonder_KeepUpWeaponSpell(OneHitWonder_Shaman_WeaponSpellName[OneHitWonder_Shaman_KeepUpWeaponBuff], OneHitWonder_Shaman_WeaponEffectName, 16, canCast);
end
