...
COUNTERWINDOW_AUTOOPENONLOAD				= "Auto open Counter Window on load";
COUNTERWINDOW_AUTOOPENONLOAD_INFO			= "Makes sure that the main Counter Window is opened on load";

COUNTERWINDOW_CHAT_AUTOOPENONLOAD_ENABLED	= "Counter Window auto open on load enabled.";
COUNTERWINDOW_CHAT_AUTOOPENONLOAD_DISABLED	= "Counter Window auto open on load disabled.";
