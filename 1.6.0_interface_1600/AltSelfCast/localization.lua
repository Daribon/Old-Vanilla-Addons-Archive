...
ALTSELFCAST_SHIFT_KEY_INFO		= "If Shift key is held down self cast will occur.";
ALTSELFCAST_CTRL_KEY			= "Allow Ctrl for Self Cast";
ALTSELFCAST_CTRL_KEY_INFO		= "If Ctrl key is held down self cast will occur.";
...
ALTSELFCAST_CHAT_COMMAND_HELP[2]	= "Example: /asc enable on";
ALTSELFCAST_CHAT_COMMAND_HELP[3]	= "enable - Enables/disables Alt-Self Casting.";
ALTSELFCAST_CHAT_COMMAND_HELP[4]	= "alt - Enables/disables the Alt-key requirement for Self Casting.";
ALTSELFCAST_CHAT_COMMAND_HELP[5]	= "shift - Enables/disables the Shift-key requirement for Self Casting.";
ALTSELFCAST_CHAT_COMMAND_HELP[6]	= "ctrl (or control) - Enables/disables the Ctrl-key requirement for Self Casting.";
ALTSELFCAST_CHAT_COMMAND_HELP[7]	= "smart - Enables/disables the Smart Self casting mode.";
ALTSELFCAST_CHAT_COMMAND_HELP[8]	= "nogroup - Enables/disables Smart Self casting in groups.";
ALTSELFCAST_CHAT_COMMAND_HELP[9]	= "override - Enables/disables the continuous self-cast override option.";
ALTSELFCAST_CHAT_COMMAND_HELP[10]	= "nodispel - Enables/disables the self-casting of Dispel Magic.";
