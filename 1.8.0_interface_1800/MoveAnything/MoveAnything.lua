...
MoveAnything_Variablesed = false;
...
function MoveAnything_Init()
	...
	if( MoveAnything_UseDefaultPositions == nil ) then
		PlayerFrame:ClearAllPoints()
		PlayerFrame:SetPoint( "TOPLEFT", "UIParent", "TOPLEFT", -19, -24 );
		TargetFrame:ClearAllPoints();
		TargetFrame:SetPoint("TOPLEFT", "UIParent", "TOPLEFT", 319, -24);
	end
end
