...
Change Log:
	...
	$Id: Meteorologist.lua 2027 2005-07-03 17:34:27Z Sinaloit $
	$Rev: 2027 $
	$LastChangedBy: Sinaloit $
	$Date: 2005-07-03 12:34:27 -0500 (Sun, 03 Jul 2005) $
...
function Meteorologist_OnEvent(event)
	...
	elseif (event == "UNIT_FOCUS") then
		Meteorologist_UpdateUnitSkyIcon(arg1);
	elseif (event == "PLAYER_TARGET_CHANGED") then
		--catch focus changes that target self, party member, or pet
		if ( UnitInParty("target") ) or ( UnitIsUnit("player", "target") ) or ( UnitIsUnit("pet", "target") ) then
