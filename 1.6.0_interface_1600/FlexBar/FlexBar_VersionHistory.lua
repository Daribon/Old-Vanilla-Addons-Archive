...
Flex Bar 
	...
	06/10/2005
		...
		01/12/2005	1. Increased LoadProfile timer.  Was 10 seconds during development,
					...
					5. Fixed bug where FBEvents.n wasn't initialized - found out due to UltimateUI.
					This is not a ultimateui bug, but ultimateui did something to point out a bug I'd 
