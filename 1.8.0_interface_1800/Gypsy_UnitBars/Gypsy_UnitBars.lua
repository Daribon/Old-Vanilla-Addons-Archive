...
Gypsy_InvertCapsulePositions["Player"] = {point = "TOPLEFT", rel = "UIParent"};
Gypsy_InvertCapsulePositions["Target"] = {point = "TOPLEFT", rel = "Gypsy_PlayerFrameCapsule", relPoint = "TOPRIGHT", x = "0", y = "2"};
Gypsy_InvertCapsulePositions["Party"] = {point = "TOP", rel = "Gypsy_PlayerFrameCapsule", relPoint = "BOTTOM", x = "-40", y = "0"};
Gypsy_InvertCapsulePositions["Pet"] = {point = "TOPLEFT", rel = "PlayerFrame", relPoint="TOPLEFT", x = "85", y = "-75"};
Gypsy_InvertCapsulePositions["PartyMember1"] = {point = "TOPLEFT", rel = "Gypsy_PartyFrameCapsuleArt", relPoint = "TOPLEFT", x = "5", y = "-5"};
--[[
Gypsy_InvertCapsulePositions = {};
