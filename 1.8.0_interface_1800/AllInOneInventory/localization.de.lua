...
if (GetLocale()=="deDE") then
	...
	ALLINONEINVENTORY_CONFIG_HEADER_INFO			= "Erlaubt es das AddOn Komplettinventar zu konfigurieren, welches es erlaubt mehrere Tascheninhalte in eine zusammen zu fassen.";
	...
	ALLINONEINVENTORY_CHAT_ALPHA_FORMAT			= "Komplettinventar: Sichtbarkeit gesetzt auf %f (0 = wie Elternfenster)";

	ALLINONEINVENTORY_CHAT_SCALE_FORMAT			= "Komplettinventar: Skalierung gesetzt auf %f (0 bedeutet wie Standard UI)";
	...
	ALLINONEINVENTORY_CHAT_LOCKED_ENABLED			= "Komplettinventar: Momentane Position festgesetzt.";
	ALLINONEINVENTORY_CHAT_LOCKED_DISABLED			= "Komplettinventar: Fenster freigegeben und kann verschoben werden.";

	ALLINONEINVENTORY_CHAT_COMMAND_INFO			= "Konfiguriert Komplettinventar mittels Kommandozeile - /allinoneinventory f\195\188r Benutzungshinweise und Hilfe eigeben.";
	...
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[4]			= " includeshotbags -  Munitionsbeutel ber\195\188cksichtigen";
	...
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[7]			= " columns - Anzahl der Spalten pro Zeile im Fenster des Komplettinventars verwenden";
	...
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[11]		= " alpha - Sichtbarkeit des Komplettinventar (0 = unsichtbar)";
	ALLINONEINVENTORY_CHAT_COMMAND_USAGE[12]		= " scale - Skalierung des Komplettinventar (0 = normal/aus, 1 = normal, 2 = doppelte Gr\195\182\195\159e)";
	...
	ALLINONEINVENTORY_CHAT_COLUMNS_FORMAT			= "Anzahl der Spalten f\195\188r das Komplettinventar auf %s eingestellt.";
	
	ALLINONEINVENTORY_CHAT_REPLACEBAGS_ENABLED		= "Komplettinventar ersetzt jetzt die regul\195\164ren Taschen.";
	ALLINONEINVENTORY_CHAT_REPLACEBAGS_DISABLED		= "Komplettinventar ersetzt jetzt die regul\195\164ren Taschen nicht mehr.";
