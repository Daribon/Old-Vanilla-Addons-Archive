...
CT_MAIL_SENDINFO = "Are you sure you want to send the mails? Total postage will be:";
...
CT_MAIL_ABORTED = "Aborted. |c00FFFFFF%d|r/|c00FFFFFF%d|r mail(s) were sent.";
...
CT_MMINBOX_OPENALLCONFIRMATION = "Are you sure you want to open all mails?";
