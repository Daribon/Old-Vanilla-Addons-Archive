...
PARTYQUESTS_HELPTEXT = "Shares quests with your party.";
...
PARTYQUESTS_MENU_AUTOJOIN = "Auto-join SkyParty";
...
-- PartyQuests
PARTYQUESTS_HELP_TIP = "Right-click the quest title\nfor menu options.";
...
-- Option regs
PQ_REPLACE_TEXT = "Replace default quest log";
PQ_REPLACE_HELPTEXT = "Shows PartyQuests when you click on the Quest Log buttons.";
PQ_REPLACE_FEEDBACK_TRUE = "The normal quest log has been replaced.";
PQ_REPLACE_FEEDBACK_FALSE = "The normal quest log is back.";
