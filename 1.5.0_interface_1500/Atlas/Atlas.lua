...
ATLAS_DROPDOWN_LIST = {
	...
	{name = "Blackrock Spire (Upper)",	file = "BlackrockSpire(Upper)"},
	{name = "Dire Maul (East)",		file = "DireMaul(East)"},
	{name = "Dire Maul (North)",		file = "DireMaul(North)"},
	{name = "Dire Maul (West)",		file = "DireMaul(West)"},
	{name = "Gnomeregan",			file = "Gnomeregan"},
	{name = "Maraudon",			file = "Maraudon"},
	{name = "Molten Core",			file = "MoltenCore"},
	{name = "Onyxia's Lair",		file = "Onyxia'sLair"},
	...
	{name = "The Temple of Atal'Hakkar",	file = "TheTempleofAtal'Hakkar"},
