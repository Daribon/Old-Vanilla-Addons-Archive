...
if ( GetLocale() == "deDE" ) then
	...
	TELLTRACK_CHAT_COMMAND_ENABLE_INFO		= "Laberbox aktivieren/deaktivieren.\n/telltrack clearall eingeben um alle Eintr\195\164ge zu l\195\182schen.";
	...
	TellTrackEnableCommands			= {"/telltracktoggle","/ttracktoggle","/telltrackenable","/ttrocknenable","/telltrackdisable","/ttrackdisable","/telltrack","/ttrack","/laberbox","/lbox"};
