...
CTA_PLAYER_LIST								= "Blacklisted Players";
...
CTA_PROMO									= "\'Call To Arms\' (CTA) is a new add-on that allows players to host, find and join groups very quickly and easily like never before. Go to curse-gaming.com, ui.worldofwar.net, wowguru.com or wowinterface.com for more details.";
CTA_OK										= "Ok";
CTA_ADD_PLAYER								= "Add player";
...
CTA_ANNOUNCE_GROUP_HELP						= "Sends a public LFM message. Use: \'cta announce <channel number>\'";
...
CTA_PROMO									= "Welcome to the group! The invitation you accepted was automatically sent by \'Call To Arms\', available at curse-gaming.com, worldofwar.net, wowguru.com and wowinterface.com";
CTA_FILTER_RESULTS							= "Optional filters";
