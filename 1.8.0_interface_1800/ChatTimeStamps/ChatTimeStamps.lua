--[[
	...
	However, the configuration is Cosmos 2 dependent. 
	
  ]]--
   
ChatTimeStamps_ENABLED = nil;
ChatTimeStamps_SEPARATOR = nil;
ChatTimeStamps_LOCALTIME = false;
...
function ChatTimeStamps_TimeStamp(msg, hour, minute)
	if (ChatTimeStamps_ENABLED) and ( msg ) and ( msg ~= "" ) and ( msg ~= " " ) then
		local separator = "";
