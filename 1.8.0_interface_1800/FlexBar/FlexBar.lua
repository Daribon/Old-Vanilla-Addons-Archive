...
--	GameTooltip:SetOwner(this);
	...
	if ( FBButtonInfoTooltipShown ) then
		...
		GameTooltip:AddLine("Flexbar Button "..FlexButtonNum)
		if (FBState[FlexButtonNum].remap ~= nil) then
			GameTooltip:AddLine("Remaped ID: "..FBState[FlexButtonNum].remap)
		end
		if (FBState[FlexButtonNum].group ~= nil) then
			GameTooltip:AddLine("Group: "..FBState[FlexButtonNum].group)
		end

		GameTooltip:AddLine("Position: <"..x..", "..y.."> Scale:"..scale)
		GameTooltip:Show()
		button.updateTooltip = TOOLTIP_UPDATE_TIME;
	end
end
