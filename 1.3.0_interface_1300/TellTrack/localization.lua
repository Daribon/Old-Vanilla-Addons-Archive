...
TELLTRACK_CONFIG_HEADER_INFO		= "Contains settings for Tell Track,\nan AddOn which makes it easier for you to talk to several people simultaneously by creating a listing of recently messaged players.\nClick the question-mark corner for more info.";

TELLTRACK_ENABLED					= "Enable Tell Track";
TELLTRACK_ENABLED_INFO				= "Toggles the visibility of the Tell Track window.";

TELLTRACK_CHAT_ENABLED				= "Tell Track enabled.\nClick the question mark in the corner of the Tell Track Window for more info.";
...
TELLTRACK_CHAT_QUESTION_MARK_INFO	= "TellTrack (by sarf and Lash)\n\nLeft Click on Slot:Send Tell\nRight Click on Slot:Options\nMouse Wheel:Scroll slots one by one (max 20)\nLeft Click on Arrows:Scroll slots page by page (max 20)\nRight Click on Arrows:Go to first or last slot respectively.";

TELLTRACK_WHISPER					= "Whisper";
TELLTRACK_WHO						= "Who";
TELLTRACK_GRPINV					= "Groupe Invite";
...
TELLTRACK_CONFIG_TRANSNUI_INFO		= "Allows you to adjust TellTrack transparency.";
