CT_AddMovable("CT_PlayerFrame_Drag", "Player frame", "TOPLEFT", "TOPLEFT", "UIParent", 97, -25, function(status)
	if ( status ) then
...
-- LedMirage 6/10/2005 [1/1] Default value change from "1" to "2"
CT_RegisterMod(CT_PLAYERSTATS_MODNAME, CT_STATS_SUBNAME, 4, "Interface\\Icons\\INV_Scroll_01", CT_PLAYERSTATS_TOOLTIP, "switch", "2", PlayerFrameModeFunction, CT_PlayerFrame_Update);
