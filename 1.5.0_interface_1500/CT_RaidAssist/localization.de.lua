if ( GetLocale() == "deDE" ) then
	...
	CT_RAMENU_BUFFSDESCRIPT = "W\195\164hle die Buffs und Debuffs welche du anzeigen lassen m\195\182chtest.\nMaximal 4 Buffs k\195\182nnen gleichzeitig angezeigt werden.\nDebuffs werden die Farbe des Fenster zu der Farbe \195\164ndern, die du ausw\195\164hlst.";
	CT_RAMENU_BUFFSTOOLTIP = "Benutze die Pfeile um Buffs nach oben oder unten zu verschieben.\nWenn mehr als das Limit angezeigt wird haben die oberen Priorit\195\164t.";
	CT_RAMENU_DEBUFFSTOOLTIP = "Benutze die Pfeile um Debuffs nach oben oder unten zu verschieben.\nWenn mehr als das Limit angezeigt wird haben die oberen Priorit\195\164t.";
...
CT_RA_POWERWORDFORTITUDE["de"] = {  "Machtwort: Seelenst\195\164rke", "Gebet der Seelenst\195\164rke" };
CT_RA_MARKOFTHEWILD["de"] = { "Mal der Wildnis", "Gabe der Wildnis" };
CT_RA_ARCANEINTELLECT["de"] = { "Arkane Intelligenz", "Arkane Brillanz" };
CT_RA_ADMIRALSHAT["de"] = "Admiralshut";
CT_RA_SHADOWPROTECTION["de"] = "Schattenschutz";
CT_RA_POWERWORDSHIELD["de"] = "Machtwort: Schild";
CT_RA_SOULSTONERESURRECTION["de"] = "Seelenstein-Auferstehung";
CT_RA_DIVINESPIRIT["de"] =  "G\195\182ttlicher Willen";
CT_RA_THORNS["de"] = "Dornen";
CT_RA_FEARWARD["de"] = "Furchtbarriere";
CT_RA_BLESSINGOFMIGHT["de"] = "Segen der Macht";
CT_RA_BLESSINGOFWISDOM["de"] = "Segen der Weisheit";
CT_RA_BLESSINGOFKINGS["de"] = "Segen der K\195\182nige";
CT_RA_BLESSINGOFSALVATION["de"] = "Segen der Rettung";
CT_RA_BLESSINGOFLIGHT["de"] = "Segen des Lichts";
CT_RA_BLESSINGOFSANCTUARY["de"] = "Segen des Refugiums";
CT_RA_REGROWTH["de"] = "Nachwachsen";
CT_RA_REJUVENATION["de"] = "Verj\195\188ngung";
CT_RA_RENEW["de"] = "Erneuerung";
CT_RA_FEIGNDEATH["de"] = "Totstellen";

CT_RA_MAGIC["de"] = "Magie";
CT_RA_DISEASE["de"] = "Krankheit";
CT_RA_POISON["de"] = "Gift";
CT_RA_CURSE["de"] = "Fluch";
CT_RA_WEAKENEDSOUL["de"] = "Geschw\195\164chte_Seele";
CT_RA_RECENTLYBANDAGED["de"] = "K\195\188rzlich_bandagiert";

-- Cures
CT_RA_DISPELMAGIC["de"] = "Magiebannung";
CT_RA_ABOLISHDISEASE["de"] = "Krankheit aufheben";
CT_RA_ABOLISHPOISON["de"] = "Vergiftung aufheben";
CT_RA_CLEANSE["de"] = "Reinigung des Glaubens";
CT_RA_PURIFY["de"] = "L\195\164utern";
CT_RA_CUREDISEASE["de"] = "Krankheit heilen";
CT_RA_CUREPOISON["de"] = "Vergiftung heilen";
CT_RA_REMOVECURSE["de"] = "Fluch aufheben";
CT_RA_REMOVELESSERCURSE["de"] = "Geringen Fluch aufheben";

-- Resurrections
CT_RA_RESURRECTION["de"] = "Auferstehung";
CT_RA_REDEMPTION["de"] = "Erl\195\182sung";
CT_RA_REBIRTH["de"] = "Wiedergeburt";
CT_RA_ANCESTRALSPIRIT["de"] = "Geist der Ahnen";