...
function MonkeyQuest_OnLoad()
	...
	MonkeyQuest_OLD_GameTooltip_OnEvent = GameTooltip_OnEvent;
	GameTooltip_OnEvent = MonkeyQuest_NEW_GameTooltip_OnEvent;
	
	-- this should catch items when you're going to sell them
	--MonkeyQuest_OLD_SetTooltipMoney = SetTooltipMoney;
...
function MonkeyQuest_OnEvent(event)
	...
	if (event == "TOOLTIP_ANCHOR_DEFAULT") then
		if (MonkeyQuest_SearchTooltip() == true) then
			GameTooltip:AddLine(MONKEYQUEST_TOOLTIP_QUESTITEM, ITEM_QUALITY6_TOOLTIP_COLOR.r, ITEM_QUALITY6_TOOLTIP_COLOR.g, ITEM_QUALITY6_TOOLTIP_COLOR.b, 1);
...
function MonkeyQuest_Refresh()
	...
	for i = 1, MonkeyQuest.m_iNumQuestButtons, 1 do
		...
		--getglobal("MonkeyQuestButton" .. i .. "Text"):SetScale(getglobal("MonkeyQuestButton" .. i .. "Text"):GetScale());
	end
...
function MonkeyQuestTitle_OnEnter()
	...
	GameTooltip:SetText(MONKEYQUEST_TITLE_VERSION, ITEM_QUALITY6_TOOLTIP_COLOR.r, ITEM_QUALITY6_TOOLTIP_COLOR.g, ITEM_QUALITY6_TOOLTIP_COLOR.b, 1);
