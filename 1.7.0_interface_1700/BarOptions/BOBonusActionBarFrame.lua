--[[
	...
	$Id: BOBonusActionBarFrame.lua 2150 2005-07-21 11:01:26Z mugendai $
	$Rev: 2150 $
...
--
--------------------------------------------------
BarOptions.BAB_FirstShow = nil;		--Set to true, once the bar is shown for the first time
...
function BOBonusActionBar_OnEvent()	
	if ( event == "UPDATE_BONUS_ACTIONBAR" ) then
		...
		if (( GetBonusBarOffset() > 0 and CURRENT_ACTIONBAR_PAGE == 1 ) and not BarOptions.BAB_FirstShow) then
			BOShowBonusActionBar();
		end
	end
end
...
function BOShowBonusActionBar()
	BarOptions.BAB_FirstShow = true;	--So we know this bar has been shown for the first time.
	BOBonusActionBar_SetButtonTransitionState(nil);
