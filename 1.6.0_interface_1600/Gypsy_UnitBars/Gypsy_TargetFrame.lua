--[[
	...
	Click catching for the target frame.
]]
...
DropDownList1:ClearAllPoints();
				-- EDIT: No longer checks for inverted values - will always anchor down (perhaps I will add a feature to check frame position and anchor accordingly) -nathanmx
			--	if (Gypsy_RetrieveOption ~= nil) then
