--[[
	...
	$Id: buildLocales.pl,v 1.8 2005/07/08 02:05:40 norganna Exp $
	Version: 3.0.10
]]
...
AUCT_RECIPE_PREFIXES={ "Recipe: ", "Pattern: ", "Plans: ", "Schematic: ", "Formula: " };
...
AUCT_HELP_MESH="Schaltet die Anzeige der 3D-Vorschau ein/aus, sofern sie verf\195\188gbar ist.";
...
AUCT_HELP_MESH="Selecciona para mostrar la imagen del art\195\173culo, si existe una";
...
AUCT_FRMT_ACT_CLEAR_OK="Informacion eliminada para el item: %s";
...
AUCT_FRMT_ACT_ENABLED_ON="Mostrando art\195\173culos %s en %s";
AUCT_FRMT_ACT_SET="Ajustado %s a '%s'";
