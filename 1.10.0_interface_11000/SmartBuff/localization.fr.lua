...
SMARTBUFF_DRUID[2] = {"Epines", 10, SMARTBUFF_CONST_GROUP, {6,14,24,34,44,54}, "MAGE;PRIEST;WARLOCK;WPET"};
SMARTBUFF_DRUID[3] = {"Augure de clart\195\169", 10, SMARTBUFF_CONST_SELF};
SMARTBUFF_DRUID[4] = {"Ecorce", 0.25, SMARTBUFF_CONST_SELF};
SMARTBUFF_DRUID[5] = {"Emprise de la nature", 0.75, SMARTBUFF_CONST_SELF};
...
SMARTBUFF_ROGUE[2]  = {"Evasion", 0.2, SMARTBUFF_CONST_SELF};
SMARTBUFF_ROGUE[3]  = {"Poison instantan\195\169 VI", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[4]  = {"Poison instantan\195\169 V", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[5]  = {"Poison instantan\195\169 IV", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[6]  = {"Poison instantan\195\169 III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[7]  = {"Poison instantan\195\169 II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[8]  = {"Poison instantan\195\169", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[9] = {"Poison douloureux IV", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[10] = {"Poison douloureux III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[11] = {"Poison douloureux II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[12] = {"Poison douloureux", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[13] = {"Poison de distraction mentale III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[14] = {"Poison de distraction mentale II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[15] = {"Poison de distraction mentale", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[16] = {"Poison mortel IV", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[17] = {"Poison mortel III", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[18] = {"Poison mortel II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[19] = {"Poison mortel", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[20] = {"Poison affaiblissant II", 30, SMARTBUFF_CONST_INV};
SMARTBUFF_ROGUE[21] = {"Poison affaiblissant", 30, SMARTBUFF_CONST_INV};
...
SMARTBUFF_PALADIN[8]  = {"B\195\169n\195\169diction de la lumi\195\168re", 5, SMARTBUFF_CONST_GROUP, {40,50,60}, "SHAMAN;WPET", "B\195\169n\195\169diction de la lumi\195\168re sup\195\169rieure", 15, {60}, {"Symbole des rois"} };
