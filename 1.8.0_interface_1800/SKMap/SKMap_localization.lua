...
SKM_UI_STRINGS = {
	...
	Options_Button_RecordPlayerDeath = "Record player deaths";
	Options_Tooltip_RecordPlayerDeath = "Keep track of your deaths";
...
SKM_UI_STRINGS = {
	...
	Options_Button_RecordPlayerDeath = "Enregistrer votre mort";
	Options_Tooltip_RecordPlayerDeath = "Enregistre vos passages \195\160 tr\195\169pas aussi bien en JcE qu'en JCJ";
	...
	Options_Tooltip_TooltipPlayerNote = "Ajouter la note associ\195\169e à un joueur ennemi \195\160 l'infobulle";
...
SKM_UI_STRINGS = {
	...
	Options_Button_RecordPlayerDeath = "Aufzeichnung eurer Tode";
	Options_Tooltip_RecordPlayerDeath = "Zeichnet auf wie oft ihr gestorben seit";
	...
	--Options_Button_SharedWarMode = "Shared WAR mode"; -- need translation
