...
If FlightPath discovers any paths that aren't already in KnownPaths.lua
(available via the '/fp load' command) please forward them along to me. Look in
the FlightPath section of your SavedVariables.lua file. Just copy it in notepad
and paste it into an email message to kwraz@kjware.net.
