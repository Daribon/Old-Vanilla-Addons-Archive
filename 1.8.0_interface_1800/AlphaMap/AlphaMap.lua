--	///////////////////////////////////////////////////////////////////////////////////////////
--
--  AlphaMap (BG) version  by Onur "Xtro" ER
--  Please read Notes.txt file for Edit Notes
--
--  Features:
--
--		   v1.7 - Battlegrounds Support
--              - Not tested with Warsong and Alterac. Tested and works well with Arathi Basin
--
--	///////////////////////////////////////////////////////////////////////////////////////////
--
...
NUM_ALPHAMAP_POIS			= 41;
NUM_ALPHAMAP_FLAGS = 2;
...
function AlphaMapFrame_Update()
	...
	if ( GetCVar("errors") ~= "0" ) then
		if ( numPOIs > NUM_ALPHAMAP_POIS ) then
...
function AlphaMapUnits_OnUpdate()
	...
	for i=1, numFlags do
		...
		if ( flagX == 0 and flagY == 0 ) then
			...
			flagX = flagX * AlphaMapDetailFrame:GetWidth();
			flagY = -flagY * AlphaMapDetailFrame:GetHeight();
			flagFrame:SetPoint("CENTER", "AlphaMapDetailFrame", "TOPLEFT", flagX, flagY);
