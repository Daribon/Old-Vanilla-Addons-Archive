...
function GPetActionBar_OnLoad()
	...
	this.Dock = function(this)
		...
		this:ClearAllPoints()	
		this:SetPoint("BOTTOMLEFT", "$parent", "BOTTOMLEFT", 75 * factor, 83 * factor)
...
function GPetActionBar_Dock()
    this:SetScale(0.6)
    factor = UIParent:GetScale() / this:GetScale()
    this:ClearAllPoints()
    this:SetPoint("BOTTOMLEFT", "$parent", "BOTTOMLEFT", 75 * factor, 85 * factor)
    GBars_LayoutHorizontal(this)
end
