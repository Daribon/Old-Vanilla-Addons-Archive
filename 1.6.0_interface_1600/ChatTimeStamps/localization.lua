...
-- Khaos Folder
CHAT_FOLDER_TITLE		= "Chat";
CHAT_FOLDER_HELP		= "These are options which affect the chat window.";
...
CHATTS_CONFIG_LOCALTIME 			= "Use your local computer time";
CHATTS_CONFIG_LOCALTIME_INFO			= "Uses the computer's clock instead of the server's clock.";
...
CHATTS_CONFIG_PERIODICSTAMPS_INFO 		= "Shows the timestamps only once every few minutes. Change the slider to select the delay";
