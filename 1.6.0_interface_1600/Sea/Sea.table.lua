...
--	$Rev: 1584 $
--	$Date: 2005-05-22 00:15:05 -0500 (Sun, 22 May 2005) $
--]]
...
Sea.table = {
	...
	-- getKeyList ( table )
	--
	-- 	Returns a table of keys (integer indexing), nil if empty table.
	--
	-- Arg:
	-- 	table - the table
	--
	-- Written by AnduinLothar (KarlKFI@ultimateuiui.org)
