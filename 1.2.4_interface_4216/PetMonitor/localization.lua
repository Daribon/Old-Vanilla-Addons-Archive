-- Version : English (by Steven Sacks)
...
PETMONITOR_SEP_INFO		= "Pet Monitor v1.1";
PETMONITOR_ENABLED		= "Enable Pet Monitor"
PETMONITOR_ENABLED_INFO		= "This will turn on pet health monitoring and send your pet's health if you're a Hunter or Warlock."
...
PETMONITOR_RECEIVER_INFO	= "--Hunter/Warlock only--\nTurn this off if you want to send but not receive pet health.";
