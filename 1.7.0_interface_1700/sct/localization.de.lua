-- Version : German (by Endymion, StarDust)
...
if ( GetLocale() == "deDE" ) then
	...
	SCT_MissMsg	= "Ferfehlt!";			-- Message to be displayed when you are missed
	SCT_ResistMsg	= "Wiederstanden!";		-- Message to be displayed when you resist
	...
	SCT_Berserk	= "Berserker Bereit!";		-- Message to be displayed when Troll's Berserking ability is Available
	...
	SCT_ComboPoint	= "CP";				-- Message to be displayed when leaving combat
	SCT_FiveCPMessage = "Erledige Ihn!";		-- Message to be displayed when you have 5 combo points
	SCT_Honor	= "Ehre";
	...
	SCT_PROFILE	= "SKT Profil geladen: |cff00ff00";
	...
	SCT_OPTION_EVENT16 = {name = "Ehrenpunkte anzeigen", tooltipText	= "Aktiviert die Anzeige wenn du Ehrenpunkte bekommst."};
	...
	SCT_OPTION_SLIDER2 = { name="Texgr\195\182\195\159e", minText="Kleiner", maxText="Gr\195\182\195\159er", tooltipText = "Legt die Gr\195\182\195\159e des dargestellten Textes fest."};
	...
	-- Cosmos button
	SCT_CB_NAME		= "Scrollender Kampftext";
	SCT_CB_SHORT_DESC	= "von Greyhoof";
