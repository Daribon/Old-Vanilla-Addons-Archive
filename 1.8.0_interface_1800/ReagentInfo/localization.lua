...
ReagentInfo_CheckButton_Recurse_HelpText = "Der 'Rezeptbaum' listet weitere Rezepte unter dem Rezept auf bei denen die damit erstellte Reagenz benötigt wird (bis zu 4 Ebenen).";
