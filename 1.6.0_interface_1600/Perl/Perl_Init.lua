function Perl_Init() 
	...
	Perl_Target_DistanceFrame:SetBackdropColor(0, 0, 0, Perl_Config.Transparency);
	Perl_Target_DistanceFrame:SetBackdropBorderColor(0.5, 0.5, 0.5, Perl_Config.Transparency);
	...
	Perl_Target_DistanceText:SetTextColor(1,1,1,1);
	...
	for num=1,4 do
		...
		getglobal("Perl_party"..num.."_DistanceFrame"):SetBackdropBorderColor(0.5, 0.5, 0.5, 1);
		getglobal("Perl_party"..num.."_DistanceFrame"):SetBackdropColor(0, 0, 0, Perl_Config.Transparency);
		...
		getglobal("Perl_party"..num.."_DistanceFrame_DistanceText"):SetTextColor(1,1,1,1);
...
function Perl_OptionActions()
	...
	if (Perl_Config.ShowPartyDistance==0) then
		Perl_HidePartyDistance();
	elseif (Perl_Config.ShowPartyDistance==1) then
		Perl_ShowPartyDistance();
	end
	...
	if (Perl_Config.ShowTargetDistance==0) then
		Perl_Target_Hide_Distance();
	elseif (Perl_Config.ShowTargetDistance==1) then
		Perl_Target_Show_Distance();
	end
