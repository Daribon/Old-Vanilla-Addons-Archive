...
function TitanPanelACWButton_SetCompactMode()
	...
	TITAN_ACW_AcknowledgeButton:SetPoint("RIGHT","TitanPanelACWButton","LEFT",12,1);
	TITAN_ACW_SnoozeButton:SetPoint("LEFT","TitanPanelACWButton","RIGHT",-12,1);

	TitanPanelACWButtonText:SetWidth(35);
	TITAN_ACW_CompactIcon:Show();
	TITAN_ACW_AcknowledgeButton:Show();
	TITAN_ACW_SnoozeButton:Show();
end
...
function TitanPanelACWButton_SetNormalMode()
	...
	TITAN_ACW_AcknowledgeButton:SetPoint("RIGHT","TitanPanelACWButton","LEFT",1,1);
	TITAN_ACW_SnoozeButton:SetPoint("LEFT","TitanPanelACWButton","RIGHT",1,1);
end
...
function TITAN_ACW_Reset()
	...
	TITAN_ACW_SnoozeButton:Hide();
	TITAN_ACW_AcknowledgeButton:Hide();
end
...
function TITAN_ACW_Alarm(msg)
	...
	TITAN_ACW_SnoozeButton:Show();
	TITAN_ACW_AcknowledgeButton:Show();
	PlaySoundFile("Interface\\AddOns\\TitanAlarmClockWrangler\\bell.mp3");
end
...
function TITAN_ACW_ButtonTooltips()
	...
	if (this == TITAN_ACW_SnoozeButton) then
		parent = "TITAN_ACW_SnoozeButton";
		text = ACW_SNOOZE_BUTTON;
	else
		parent = "TITAN_ACW_AcknowledgeButton";
