...
--	English By: Mugendai
--	
--	$Id: localization.fr.lua 1441 2005-05-05 08:41:19Z Sinaloit $
--	$Rev: 1441 $
--	$LastChangedBy: Sinaloit $ Sasmira
--	$Date: 2005-05-05 10:41:19 +0200 (Thu, 05 May 2005) $ 04/02/2005
--]]
...
BAROPTIONS_CHAT_ALTERNATEIDS = "Utiliser un ID particulier %s";
BAROPTIONS_CHAT_GROUPPAGES = "Groupe Pages %s";
BAROPTIONS_CHAT_STANCEBAR = "Position de la Barre Inf\195\169rieure Gauche %s";
BAROPTIONS_CHAT_HIDEEMPTY = "Cacher les boutons vides %s";
BAROPTIONS_CHAT_HIDEKEYS = "Cacher les Raccourcis %s";
BAROPTIONS_CHAT_MULTIKEYS = "Activer les Raccourcis des Multi Barres %s";
BAROPTIONS_CHAT_SHORTKEYS = "Ecourter le texte des Raccourcis %s";
BAROPTIONS_CHAT_HIDEKEYMOD = "Cacher le texte des Raccourcis %s";
BAROPTIONS_CHAT_MAINART = "Image de fond de la Barre Principale %s%";
BAROPTIONS_CHAT_BLART = "Image de fond de la Barre Inf\195\169rieure Gauche %s%";
BAROPTIONS_CHAT_BRART = "Image de fond de la Barre Inf\195\169rieure Droite %s%";
BAROPTIONS_CHAT_RART = "Image de fond de la Barre Droite %s%";
BAROPTIONS_CHAT_LART = "Image de fond de la Barre Gauche %s%";
BAROPTIONS_CHAT_BLCOUNT = "Boutons de la Barre Inf\195\169rieure Gauche %s";
BAROPTIONS_CHAT_BRCOUNT = "Boutons de la Barre Inf\195\169rieure Droite %s";
BAROPTIONS_CHAT_RCOUNT = "Boutons de la Barre Droite %s";
BAROPTIONS_CHAT_LCOUNT = "Boutons de la Barre Gauche %s";
BAROPTIONS_CHAT_RANGECOLOR_RANGE = " Doit \195\170tre entre 1 et 0, comme 0.2";
BAROPTIONS_CHAT_RANGECOLOR = "Couleur d\'une Cible Hors de Port\195\169e %s";
BAROPTIONS_CHAT_RANGECOLORRED = "Couleur Rouge r\195\69gl\195\169e \195\160 %s%";
BAROPTIONS_CHAT_RANGECOLORGREEN = "Couleur Verte r\195\69gl\195\169e \195\160 %s%";
BAROPTIONS_CHAT_RANGECOLORBLUE = "Couleur Bleue r\195\69gl\195\169e \195\160 %s%";
BAROPTIONS_CHAT_CUSTOMSTANCES = "Activer la configuration de la Position des Pages %s";
BAROPTIONS_CHAT_STANCE_RANGE = " Doit \195\170tre entre 1 et 10";
BAROPTIONS_CHAT_STANCE0 = "Aucune Position de Page() %s";
BAROPTIONS_CHAT_STANCE1 = "Position Page 1 (Combat/chat/furtif) %s";
BAROPTIONS_CHAT_STANCE2 = "Position Page 2 Page(D\195\169fense) %s";
BAROPTIONS_CHAT_STANCE3 = "Position Page 3(Berserker/Ours) %s";
