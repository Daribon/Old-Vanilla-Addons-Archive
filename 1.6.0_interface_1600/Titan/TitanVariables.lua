...
function TitanVariables_InitPlayerSettings() 
	...
	if (not TitanSettings.Players[playerName]) then
		TitanSettings.Players[playerName] = {};
		TitanSettings.Players[playerName].Plugins = {};
		TitanSettings.Players[playerName].Panel = {};
		TITAN_FIRST_LOAD = 1;		
	end	
	
	-- Set global variables
	TitanPlayerSettings = TitanSettings.Players[playerName];
